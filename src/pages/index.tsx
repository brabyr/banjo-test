                    ...
                    <Box sx={{ m: '30px 0px'}}>
                        ...
                        <Box sx={{width: '100%', mt: 4}}>
                            ...
                            <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="en">
                                <DatePicker defaultValue={dayjs('01/01/2024')} sx={{width: '100%', backgroundColor: '#fff'}} format="MM/DD/YYYY" onChange={(newValue: any) => setData({ ...data, date: dayjs(newValue).format('MM/DD/YYYY') })}/>
